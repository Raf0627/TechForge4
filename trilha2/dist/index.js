...
const Temperatura_1 = require("./Temperatura");
const Agenda_1 = require("./Agenda");
console.log("CONTA BANCÁRIA");
const minhaConta = new ContaBancaria_1.ContaBancaria("João Pedro", 100);
...
console.log();
console.log("LIVRO");
const harryp = new Livro_1.Livro("Harry Potter", "JK Rowlling", 310);
console.log(`Status de "${harryp.titulo}": ${harryp.getStatus()}`);
harryp.marcarComoLido();
console.log(`Status de "${harryp.titulo}": ${harryp.getStatus()}`);
console.log();
console.log("PRODUTO");
const monitor = new Produto_1.Produto("Monitor", 999.50, 5);
monitor.calcularValorTotalEstoque();
console.log();
console.log("TEMPERATURA");
const tempCelsius = new Temperatura_1.Temperatura(25);
...
console.log();
console.log("AGENDA");
const agendaDoDia = new Agenda_1.Agenda();
